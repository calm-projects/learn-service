 ...
 * 描述信息
 */
public class C03_HBaseDDL {
    // 添加静态属性 connection 指向单例连接
    public static Connection connection = C02_HBaseConnect02.connection;
     ...
     * @return true 表示删除成功
     */
    public static void aheadSetRegion(String namespace, String tableName) throws IOException {
        // 1.获取 admin
        Admin admin = connection.getAdmin();
        // 2.获取 descriptor 的 builder
