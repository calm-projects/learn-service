...
public class SinkFile3_Parquet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<User> userDs = env.socketTextStream("hadoop03", 8888).uid("socket-source")
        ...
        FileSink<User> sink = FileSink
                .forBulkFormat(new Path("data/flink/output/"), AvroParquetWriters.forReflectRecord(User.class))
